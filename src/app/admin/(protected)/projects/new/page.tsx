  ...
  const [state, formAction, isPending] = useActionState(
    async (prevState: any, formData: FormData) => {
      try {
        ...
        return { success: false, error: err.message || "Gagal membuat proyek" };
      }
    },
    initialState
  );
  ...
  return (
    <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-serif font-medium text-forest-900">Proyek Baru</h1>
        <p className="text-forest-700 mt-2 text-sm leading-relaxed">
          Tambahkan detail karya interior terbaru ke dalam sistem portfolio.
        </p>
      </div>
