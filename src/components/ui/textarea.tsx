  ...
  return (
    <textarea
      className={cn(
        ...
        variant === "inverse" && "field-dark rounded-[var(--radius-sm)] text-text-inverse disabled:opacity-50 disabled:cursor-not-allowed aria-[invalid=true]:border-red-500 aria-[invalid=true]:focus:ring-red-500/15",
